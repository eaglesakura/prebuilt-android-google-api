...
public  final class HttpRequest extends
  ...
  public int getSerializedSize() {
    ...
    if (!serverIp_.isEmpty()) {
      size += com.google.protobuf.CodedOutputStream
        .computeStringSize(13, getServerIp());
    }
    if (latency_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public static final class Builder extends
    ...
    public Builder setLatency(
        com.google.protobuf.Duration.Builder builderForValue) {
      copyOnWrite();
      instance.setLatency(builderForValue);
      return this;
    }
    /**
     * <pre>
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        latency_ = visitor.visitMessage(latency_, other.latency_);
        cacheLookup_ = visitor.visitBoolean(cacheLookup_ != false, cacheLookup_,
            other.cacheLookup_ != false, other.cacheLookup_);
        cacheHit_ = visitor.visitBoolean(cacheHit_ != false, cacheHit_,
            other.cacheHit_ != false, other.cacheHit_);
        cacheValidatedWithOriginServer_ = visitor.visitBoolean(cacheValidatedWithOriginServer_ != false, cacheValidatedWithOriginServer_,
            other.cacheValidatedWithOriginServer_ != false, other.cacheValidatedWithOriginServer_);
        cacheFillBytes_ = visitor.visitLong(cacheFillBytes_ != 0L, cacheFillBytes_,
            other.cacheFillBytes_ != 0L, other.cacheFillBytes_);
